...
describe("Rhythm", () => {
  ...
  describe("is a Sequence", () => {
    it("should have steps that can be returned as values", () => assert.deepEqual(rhythm.steps, [1, 1, 0]));
    it("should have step values of 1 or 0", () => rhythm.steps.forEach(step => assert.ok(step === 0 || step === 1)));
  });
